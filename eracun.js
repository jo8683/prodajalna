...
streznik.get('/', function(zahteva, odgovor) {
  ...
  // preverimo ali imamo katerikoli id od strank v bazi
  // kar pomeni, da smo prijavljeni
  if(zahteva.session.strankaId) {
...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    strankaIzRacuna(polja.seznamRacunov, function(napakaStranke, stranke) {
      ...
      try {
        var stmt = pb.prepare("\
      	...
      	stmt.run(polja.FirstName,
      	         ...
      	         polja.Fax,
      	         polja.Email,
      	         3); // SupportRepId - dolocčeno v navodilih
...
streznik.post('/odjava', function(zahteva, odgovor) {
    // ponastavimo id izbrane stranke
